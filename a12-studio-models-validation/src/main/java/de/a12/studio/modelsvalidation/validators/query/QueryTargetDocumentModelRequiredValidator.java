...
/**
 * A Query Model must have a target Document Model. Whether the reference actually resolves in the workspace is
 * checked separately by the generic {@link de.a12.studio.modelsvalidation.validators.HeaderModelReferenceValidator}
 * (the target is synced into a header DOCUMENT-type reference by {@code QuerySettingsPanelController} whenever
 * it's changed in the UI).
 */
