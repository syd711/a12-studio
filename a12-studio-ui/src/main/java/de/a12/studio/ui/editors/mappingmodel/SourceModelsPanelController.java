 ...
 * e.g. {@link de.a12.studio.ui.editors.overviewmodel.OverviewColumnsPanelController}. Clicking a row opens {@link Dialogs#showSourceModelForEdit}
...
public class SourceModelsPanelController extends AbstractPropertyEditor {
  ...
  private void openModel(MappingSource sourceModel) {
    ProjectDocumentModels.openModelInEditor(sourceModel.getDmId());
  }
