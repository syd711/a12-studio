 ...
 * plus the actual reference to whichever kind is selected. Mirrors {@link
 * de.a12.studio.ui.editors.overviewmodel.OverviewReferencePanelController}'s
...
public class MainModelReferencePanelController implements Initializable {
   ...
   * de.a12.studio.ui.editors.documentmodel.IncludePropertiesPanelController#onEditReference}.
   */
  @FXML
