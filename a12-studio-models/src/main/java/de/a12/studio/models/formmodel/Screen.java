...
public class Screen {
  ...
  // Id of the Control that should receive keyboard focus when this screen is shown. SME only allows it on the
  // first screen, and only for an editable Control outside any repeat (FormInitiallyFocusedElementValidator).
  @JsonInclude(JsonInclude.Include.NON_EMPTY)
